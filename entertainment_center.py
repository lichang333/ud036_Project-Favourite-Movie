#entertainment_center.py is using to create movie instances though fresh_tomatoes.py
...
despicable_me2 = media.Movie("Despicable Me2",
						"",
...
movies = [despicable_me2, coco, forrest_gump, dead_poets_society, wall_e, inside_out]
